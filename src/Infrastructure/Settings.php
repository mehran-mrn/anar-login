...
final class Settings {
	...
	public function defaults() {
		return array(
			...
			'sms_message'         => __( 'Your {site} login code is: {code}', 'anar-login' ),
			'email_subject'       => __( 'Your login code for {site}', 'anar-login' ),
			'email_message'       => __( "Your login code is: {code}\nThis code is valid for {minutes} minutes.", 'anar-login' ),
			'google_enabled'      => 0,
			'google_client_id'    => '',
			'google_secret'       => '',
			'brand_color'         => '#d81b3f',
